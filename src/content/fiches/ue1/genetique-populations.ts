  ...
  qcm: [
    {
      ...
      propositions: [
        ...
        },
        {
          ...
          vraie: true,
          justification: 'Une taille de population suffisante limite la dérive génétique aléatoire, et le croisement aléatoire (panmixie) est nécessaire pour que les fréquences alléliques déterminent directement les fréquences génotypiques.',
        },
        {
          lettre: 'C',
        ...
        },
        {
          ...
          vraie: true,
          justification: 'Connaissant la fréquence des sujets atteints (q^2), on calcule q puis p, ce qui donne la fréquence des hétérozygotes 2pq, souvent bien supérieure à celle des homozygotes atteints pour une maladie rare.',
        },
        {
          lettre: 'E',
      ...
      propositions: [
        {
          ...
          vraie: true,
          justification: 'Les apparentés partagent une proportion accrue d’allèles identiques par descendance, ce qui augmente la probabilité que leurs enfants reçoivent deux copies du même allèle à un locus donné.',
        },
        {
          lettre: 'B',
          texte: 'Elle augmente spécifiquement le risque de maladies autosomiques récessives rares.',
          vraie: true,
          justification: 'L’élévation de la probabilité d’homozygotie touche en priorité l’expression des maladies récessives, qui ne se manifestent qu’à l’état homozygote.',
        },
        {
          lettre: 'C',
        ...
        },
        {
          ...
          vraie: true,
          justification: 'C’est par définition la probabilité que les deux allèles d’un locus donné, hérités du père et de la mère, proviennent d’un même ancêtre commun.',
        },
        {
          lettre: 'E',
          texte: 'La consanguinité n’a aucun effet sur la fréquence des maladies autosomiques dominantes.',
          vraie: true,
          justification: 'Une maladie dominante s’exprime dès l’état hétérozygote : l’augmentation de l’homozygotie liée à la consanguinité n’influence donc pas son risque de survenue.',
        },
      ],
      ...
      propositions: [
        {
          ...
          vraie: true,
          justification: 'Deux amorces s’hybrident chacune sur un brin, de part et d’autre de la séquence cible, et délimitent ainsi la région qui sera amplifiée à chaque cycle.',
        },
        {
          lettre: 'B',
        ...
        },
        {
          ...
          vraie: true,
          justification: 'L’étape de dénaturation à haute température répétée à chaque cycle détruirait une ADN polymérase classique ; c’est pourquoi la PCR utilise une enzyme thermostable comme la Taq polymérase.',
        },
        {
          lettre: 'D',
          texte: 'La quantité d’ADN cible double théoriquement à chaque cycle.',
          vraie: true,
          justification: 'Chaque brin néosynthétisé sert à son tour de matrice au cycle suivant, ce qui conduit à une amplification exponentielle en base deux du nombre de copies.',
        },
        {
          lettre: 'E',
    ...
    },
    {
      ...
      propositions: [
        ...
        },
        {
          ...
          vraie: true,
          justification: 'Le gel oppose une résistance croissante avec la taille du fragment, si bien que les petits fragments traversent plus facilement les mailles du gel et migrent plus loin.',
        },
        {
          lettre: 'C',
          texte: 'L’électrophorèse peut servir à vérifier le résultat d’une PCR.',
          vraie: true,
          justification: 'La migration du produit de PCR permet de vérifier, par comparaison avec un marqueur de taille, que le fragment amplifié a bien la longueur attendue.',
        },
        {
          lettre: 'D',
        ...
        },
        {
          ...
          vraie: true,
          justification: 'Déposé dans un puits voisin, ce marqueur contient des fragments de tailles connues qui servent de référence pour estimer, par comparaison des distances migrées, la taille des fragments inconnus.',
        },
      ],
      ...
      propositions: [
        {
          ...
          vraie: true,
          justification: 'Ces analogues de nucléotides, dépourvus d’hydroxyle en 3′, sont incorporés aléatoirement par l’ADN polymérase et stoppent l’élongation, générant des fragments de toutes tailles qui révèlent la séquence.',
        },
        {
          lettre: 'B',
        ...
        },
        {
          ...
          vraie: true,
          justification: 'Les fragments de tailles différentes, marqués par un fluorochrome selon la base terminale, sont séparés dans un capillaire fin puis détectés par ordre de taille croissante pour reconstituer la séquence.',
        },
        {
          lettre: 'D',
        ...
        },
        {
          ...
          vraie: true,
          justification: 'Sa fiabilité et sa simplicité en font la méthode de référence pour valider un variant unique préalablement repéré, par exemple par séquençage haut débit.',
        },
      ],
      ...
      propositions: [
        {
          ...
          vraie: true,
          justification: 'Des millions de fragments d’ADN sont séquencés simultanément sur un même support, contrairement au séquençage de Sanger qui traite une séquence à la fois.',
        },
        {
          lettre: 'B',
          texte: 'Il est utile pour le diagnostic de maladies génétiquement hétérogènes, impliquant de nombreux gènes possibles.',
          vraie: true,
          justification: 'Le séquençage massivement parallèle permet d’analyser simultanément de nombreux gènes candidats, ce qui est particulièrement adapté aux maladies pouvant résulter de mutations dans l’un ou l’autre de plusieurs gènes.',
        },
        {
          lettre: 'C',
        ...
        },
        {
          ...
          vraie: true,
          justification: 'Sa grande sensibilité permet de détecter des mutations acquises présentes uniquement dans les cellules tumorales, absentes du génome constitutionnel.',
        },
        {
          lettre: 'E',
