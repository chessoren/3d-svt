  ...
  qcm: [
    {
      ...
      propositions: [
        ...
        },
        {
          ...
          vraie: true,
          justification: 'Exact : illness renvoie à la façon dont le patient perçoit et vit son état, indépendamment de sa traduction biologique objective (disease).',
        },
      ],
    ...
    },
    {
      ...
      propositions: [
        ...
        },
        {
          ...
          vraie: true,
          justification: 'Exact : c’est dans cet ouvrage que Canguilhem développe sa critique de la norme biologique purement statistique.',
        },
        {
          lettre: 'E',
          texte: 'Il considère le pathologique comme une réduction de la capacité d’adaptation de l’organisme.',
          vraie: true,
          justification: 'Exact : pour Canguilhem, le pathologique correspond à une normativité rétrécie, une incapacité à instituer de nouvelles normes face au milieu.',
        },
      ],
      ...
      propositions: [
        {
          ...
          vraie: true,
          justification: 'Exact : ce psychiatre a proposé en 1977 d’intégrer conjointement les dimensions biologique, psychologique et sociale dans la compréhension de la maladie.',
        },
        {
          lettre: 'B',
        ...
        },
        {
          ...
          vraie: true,
          justification: 'Exact : ce modèle explique la maladie par une lésion, un agent pathogène ou un dysfonctionnement mesurable, qu’il cherche à corriger.',
        },
        {
          lettre: 'E',
          texte: 'Le modèle biopsychosocial considère le patient comme acteur de la démarche de soin.',
          vraie: true,
          justification: 'Exact : contrairement au modèle biomédical où le patient est plutôt un receveur passif, le modèle biopsychosocial en fait un partenaire de la démarche de soin.',
        },
      ],
      ...
      propositions: [
        {
          ...
          vraie: true,
          justification: 'Exact : en synthétisant plusieurs essais randomisés contrôlés, elles offrent la puissance statistique et la robustesse méthodologique les plus élevées.',
        },
        {
          lettre: 'B',
    ...
    },
    {
      ...
      propositions: [
        ...
        },
        {
          ...
          vraie: true,
          justification: 'Exact : si l’effet observé augmente avec l’intensité ou la durée de l’exposition, cela plaide en faveur d’un lien causal réel plutôt que d’un simple artéfact.',
        },
        {
          lettre: 'D',
    ...
    },
    {
      ...
      propositions: [
        ...
        },
        {
          ...
          vraie: true,
          justification: 'Exact : c’est la définition même de ce modèle proposé par Engel, qui refuse de réduire la maladie à sa seule dimension biologique.',
        },
        {
          lettre: 'C',
        ...
        },
        {
          ...
          vraie: true,
          justification: 'Exact : il lui oppose une conception dynamique de la santé comme capacité de l’organisme à instituer de nouvelles normes face au milieu.',
        },
        {
          lettre: 'E',
          texte: 'L’OMS a proposé sa définition de la santé en 1946.',
          vraie: true,
          justification: 'Exact : c’est en 1946 que l’Organisation mondiale de la santé a défini la santé comme un état de complet bien-être physique, mental et social.',
        },
      ],
      correction: 'Réponses exactes : B, D et E.',
      difficulte: 2,
