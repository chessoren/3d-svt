  ...
  qcm: [
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'La clavicule est sous-cutanée sur toute sa longueur.', vraie: true, justification: 'Cette situation superficielle la rend facilement palpable et explique sa vulnérabilité aux traumatismes directs du moignon de l’épaule.' },
        { lettre: 'B', texte: 'La scapula porte la cavité glénoïdale.', vraie: true, justification: 'Cette surface articulaire peu profonde, portée par l’angle latéral de la scapula, s’articule avec la tête humérale pour former l’articulation scapulohumérale.' },
        ...
        { lettre: 'D', texte: 'Le processus coracoïde appartient à la scapula.', vraie: true, justification: 'Ce processus antérieur de la scapula sert d’insertion au chef court du biceps brachial, au coracobrachial et au petit pectoral.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'L’articulation scapulohumérale est une énarthrose.', vraie: true, justification: 'La tête humérale sphérique s’articule dans la cavité glénoïdale concave, ce qui offre trois degrés de liberté et la plus grande mobilité de toutes les diarthroses.' },
        { lettre: 'B', texte: 'L’articulation sternoclaviculaire comporte un disque articulaire intra-articulaire.', vraie: true, justification: 'Ce disque fibrocartilagineux améliore la congruence entre les surfaces sternale et claviculaire et amortit les contraintes transmises par le membre supérieur.' },
        ...
        { lettre: 'D', texte: 'Le labrum glénoïdal augmente la congruence de l’articulation scapulohumérale.', vraie: true, justification: 'Ce bourrelet fibrocartilagineux périphérique approfondit la cavité glénoïdale, augmentant la surface de contact avec la tête humérale et la stabilité passive.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Le supra-épineux est innervé par le nerf suprascapulaire.', vraie: true, justification: 'Ce même nerf innerve également l’infra-épineux, après avoir traversé l’incisure scapulaire sous le ligament transverse supérieur de la scapula.' },
        ...
        { lettre: 'C', texte: 'Le subscapulaire se termine sur le tubercule mineur de l’humérus.', vraie: true, justification: 'C’est le seul muscle de la coiffe à se terminer sur le tubercule mineur, ce qui explique son action de rotation médiale, opposée à celle des trois autres.' },
        { lettre: 'D', texte: 'Le petit rond est innervé par le nerf axillaire.', vraie: true, justification: 'Il se distingue ainsi des trois autres muscles de la coiffe, innervés par le nerf suprascapulaire ou les nerfs subscapulaires.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Le biceps brachial possède un chef long et un chef court.', vraie: true, justification: 'Le chef long naît du tubercule supra-glénoïdal et le chef court du processus coracoïde ; les deux se rejoignent pour former le corps musculaire.' },
        ...
        { lettre: 'C', texte: 'Le triceps brachial se termine sur l’olécrâne de l’ulna.', vraie: true, justification: 'Ses trois chefs convergent en un tendon commun qui se termine sur l’olécrâne, permettant l’extension du coude.' },
        { lettre: 'D', texte: 'Le chef long du triceps brachial naît du tubercule infra-glénoïdal de la scapula.', vraie: true, justification: 'Cette origine scapulaire, propre au chef long, explique qu’il soit aussi le seul des trois chefs à agir sur l’articulation scapulohumérale, en participant à l’extension de l’épaule.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Il est formé par les rameaux ventraux de C5 à T1.', vraie: true, justification: 'Ces cinq rameaux ventraux constituent les racines du plexus, premier maillon de sa réorganisation en troncs, divisions, faisceaux puis branches terminales.' },
        ...
        { lettre: 'C', texte: 'Le faisceau postérieur donne naissance au nerf radial.', vraie: true, justification: 'Le faisceau postérieur donne les nerfs axillaire et radial, tous deux destinés aux muscles issus de la loge postérieure du membre.' },
        { lettre: 'D', texte: 'Le faisceau latéral participe à la formation du nerf médian.', vraie: true, justification: 'Le nerf médian naît de deux racines, l’une issue du faisceau latéral, l’autre du faisceau médial, qui s’unissent en avant de l’artère axillaire.' },
    ...
    },
    {
      ...
      propositions: [
        ...
        { lettre: 'B', texte: 'Les muscles de la coiffe des rotateurs jouent un rôle majeur de stabilisation active.', vraie: true, justification: 'Leur contraction plaque en permanence la tête humérale contre la cavité glénoïdale, compensant la faible stabilité passive due à la surface articulaire peu profonde.' },
        { lettre: 'C', texte: 'Le rythme scapulohuméral décrit la coordination entre le mouvement de la scapula et celui de l’articulation scapulohumérale lors de l’élévation du bras.', vraie: true, justification: 'Ce rythme, proche de deux degrés de mouvement scapulohuméral pour un degré de rotation scapulaire, permet d’atteindre l’élévation complète du bras au-dessus de la tête.' },
        { lettre: 'D', texte: 'Le muscle dentelé antérieur participe à la fixation de la scapula sur le thorax.', vraie: true, justification: 'Il fait partie des muscles fixateurs de la scapula, avec le trapèze et les rhomboïdes, qui assurent la mobilité de l’articulation scapulothoracique.' },
