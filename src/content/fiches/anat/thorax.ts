  ...
  qcm: [
    {
      ...
      propositions: [
        ...
        { lettre: 'C', texte: 'L’angle sternal correspond au niveau du cartilage de la deuxième côte.', vraie: true, justification: 'Ce relief palpable entre manubrium et corps du sternum sert de point de départ pour compter les espaces intercostaux successifs.' },
    ...
    },
    {
      ...
      propositions: [
        ...
        { lettre: 'B', texte: 'Les intercostaux externes élèvent les côtes.', vraie: true, justification: 'Leurs fibres obliques, tendues du bord inférieur d’une côte au bord supérieur de la côte sous-jacente, augmentent le volume thoracique lors de l’inspiration forcée.' },
        ...
        { lettre: 'E', texte: 'Le diaphragme est un muscle digastrique en forme de dôme.', vraie: true, justification: 'Ses fibres périphériques convergent vers le centre phrénique tendineux, ce qui lui donne sa forme caractéristique en coupole.' },
      ],
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'L’orifice de la veine cave inférieure se situe à T8.', vraie: true, justification: 'Cet orifice, le plus haut des trois, traverse le centre tendineux du diaphragme, ce qui le maintient ouvert lors de la contraction diaphragmatique.' },
        ...
        { lettre: 'D', texte: 'Le conduit thoracique traverse le hiatus aortique.', vraie: true, justification: 'Il chemine avec l’aorte et la veine azygos par cet orifice le plus postérieur, situé contre le rachis à hauteur de T12.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Le cœur se situe dans le médiastin moyen.', vraie: true, justification: 'Il occupe, avec le péricarde et les racines des gros vaisseaux, cet étage central du médiastin autour duquel s’organisent les autres compartiments.' },
        { lettre: 'B', texte: 'L’œsophage traverse le médiastin postérieur.', vraie: true, justification: 'Il y chemine avec l’aorte thoracique descendante, le conduit thoracique et la veine azygos, avant de franchir le diaphragme par son hiatus propre.' },
        ...
        { lettre: 'D', texte: 'Le médiastin est compris entre les deux plèvres.', vraie: true, justification: 'Cet espace médian, limité latéralement par les deux cavités pleurales, s’étend du défilé cervicothoracique au diaphragme.' },
        { lettre: 'E', texte: 'La crosse de l’aorte se situe dans le médiastin supérieur.', vraie: true, justification: 'Avec la trachée, l’œsophage et le thymus, elle occupe cet étage situé au-dessus du plan de l’angle sternal.' },
      ],
    ...
    },
    {
      ...
      propositions: [
        ...
        { lettre: 'B', texte: 'La cavité pleurale contient un film de liquide pleural.', vraie: true, justification: 'Ce mince film liquidien lubrifie l’espace virtuel entre les deux feuillets et permet leur glissement lors des mouvements respiratoires.' },
        ...
        { lettre: 'D', texte: 'Le récessus costodiaphragmatique est un point déclive de la cavité pleurale.', vraie: true, justification: 'Cette position déclive en fait le site où s’accumule préférentiellement un épanchement liquidien, et donc le site habituel de ponction.' },
        { lettre: 'E', texte: 'Le feuillet pariétal se subdivise en plèvre costale, médiastinale et diaphragmatique.', vraie: true, justification: 'Cette nomenclature reflète simplement la structure contre laquelle s’applique le feuillet pariétal à chaque niveau.' },
      ],
      correction: 'Réponses exactes : B, D et E.',
      difficulte: 2,
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Une côte typique comprend une tête, un col, un tubercule et un corps.', vraie: true, justification: 'La tête et le tubercule s’articulent respectivement avec les corps vertébraux et l’apophyse transverse, tandis que le corps se prolonge en avant par le cartilage costal.' },
