  ...
  qcm: [
    ...
    },
    {
      ...
      propositions: [
        ...
        { lettre: 'B', texte: 'L’épiphyse est formée d’os spongieux entouré d’une fine corticale compacte.', vraie: true, justification: 'Exact.' },
        ...
        { lettre: 'D', texte: 'L’endoste tapisse la face interne de l’os compact au contact de la cavité médullaire.', vraie: true, justification: 'Exact.' },
    ...
    },
    {
      ...
      propositions: [
        ...
        { lettre: 'C', texte: 'L’ostéocyte est logé dans une logette appelée ostéoplaste.', vraie: true, justification: 'Exact.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'L’ossification endochondrale passe par un modèle cartilagineux.', vraie: true, justification: 'Exact.' },
        ...
        { lettre: 'C', texte: 'Le cartilage de croissance se situe entre la métaphyse et l’épiphyse.', vraie: true, justification: 'Exact.' },
        { lettre: 'D', texte: 'La fermeture des cartilages de croissance marque la fin de la croissance en longueur.', vraie: true, justification: 'Exact.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'L’ostéoblaste synthétise la matrice osseuse.', vraie: true, justification: 'Exact.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'L’artère nourricière principale pénètre l’os par le foramen nourricier.', vraie: true, justification: 'Exact.' },
        { lettre: 'B', texte: 'Elle se divise en une branche ascendante et une branche descendante dans le canal médullaire.', vraie: true, justification: 'Exact.' },
        { lettre: 'C', texte: 'Le réseau périosté vascularise la partie superficielle de l’os compact via les canaux de Volkmann.', vraie: true, justification: 'Exact.' },
        ...
        { lettre: 'E', texte: 'Les artères métaphysaires participent à la vascularisation des extrémités de l’os.', vraie: true, justification: 'Exact.' },
      ],
