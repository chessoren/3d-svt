  ...
  qcm: [
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Le tibia est médial, la fibula est latérale.', vraie: true, justification: 'Cette disposition correspond à la position anatomique de référence, le tibia porteur du poids étant médial et la fibula fine étant latérale.' },
        ...
        { lettre: 'C', texte: 'La malléole latérale est plus longue et plus distale que la malléole médiale.', vraie: true, justification: 'Cette asymétrie renforce la stabilité latérale de la cheville, la malléole fibulaire descendant plus bas que la malléole tibiale.' },
        { lettre: 'D', texte: 'La membrane interosseuse crurale relie le tibia et la fibula.', vraie: true, justification: 'Cette membrane fibreuse tendue entre les deux os sert de surface d’insertion à plusieurs muscles profonds de la jambe et transmet une partie des contraintes.' },
        { lettre: 'E', texte: 'La tubérosité tibiale reçoit l’insertion du tendon patellaire.', vraie: true, justification: 'Ce relief antérieur du tibia proximal constitue le point d’ancrage distal de l’appareil extenseur du genou.' },
      ],
    ...
    },
    {
      ...
      propositions: [
        ...
        { lettre: 'B', texte: 'Le ménisque latéral est plus mobile que le ménisque médial.', vraie: true, justification: 'Sa forme fermée en O et ses attaches plus lâches lui confèrent une plus grande mobilité, ce qui le rend moins exposé aux lésions traumatiques.' },
        { lettre: 'C', texte: 'Les ligaments croisés sont intracapsulaires et extrasynoviaux.', vraie: true, justification: 'Situés dans l’échancrure intercondylienne, ils se trouvent à l’intérieur de la capsule articulaire mais en dehors de la cavité synoviale proprement dite.' },
        ...
        { lettre: 'E', texte: 'La triade malheureuse associe une lésion du ligament croisé antérieur, du ligament collatéral tibial et du ménisque médial.', vraie: true, justification: 'Cette association, décrite par O’Donoghue, résulte d’un traumatisme en valgus-flexion-rotation latérale et illustre la proximité anatomique de ces trois structures.' },
      ],
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Le tibial antérieur appartient à la loge antérieure.', vraie: true, justification: 'Innervé par le nerf fibulaire profond, il assure avec les extenseurs des orteils la flexion dorsale de la cheville.' },
        { lettre: 'B', texte: 'Le triceps sural appartient à la loge postérieure superficielle.', vraie: true, justification: 'Formé des gastrocnémiens et du soléaire, il constitue le principal fléchisseur plantaire de la cheville, innervé par le nerf tibial.' },
        ...
        { lettre: 'D', texte: 'Le tendon calcanéen se termine sur le calcanéus.', vraie: true, justification: 'Ce tendon terminal commun du triceps sural s’insère sur la face postérieure du calcanéus et transmet la force de flexion plantaire à l’arrière-pied.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Le tarse comprend sept os.', vraie: true, justification: 'Talus et calcanéus en arrière, naviculaire au milieu, cuboïde et trois cunéiformes en avant : ces sept os courts forment l’arrière-pied et le médio-pied.' },
        ...
        { lettre: 'C', texte: 'L’arche longitudinale médiale s’étend du calcanéus à la tête du premier métatarsien.', vraie: true, justification: 'C’est la plus haute et la plus souple des arches plantaires, formée par le calcanéus, le talus, l’os naviculaire, les cunéiformes et le premier métatarsien.' },
        ...
        { lettre: 'E', texte: 'L’arche transversale relie les têtes des métatarsiens.', vraie: true, justification: 'Cette arche complète les deux arches longitudinales pour donner à l’avant-pied sa forme tridimensionnelle et répartir les points d’appui plantaires.' },
      ],
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Le nerf tibial assure la flexion plantaire.', vraie: true, justification: 'Il innerve les loges postérieures de la jambe, dont le triceps sural, principal moteur de la flexion plantaire de cheville.' },
        { lettre: 'B', texte: 'Le nerf fibulaire commun est exposé à une compression au col de la fibula.', vraie: true, justification: 'Son trajet y devient très superficiel, ce qui l’expose à une compression lors d’un alitement prolongé, d’un plâtre serré ou d’un traumatisme direct.' },
        { lettre: 'C', texte: 'Une lésion du nerf fibulaire commun entraîne un pied tombant.', vraie: true, justification: 'La paralysie des muscles releveurs du pied qu’il innerve empêche la flexion dorsale de cheville, provoquant un steppage caractéristique à la marche.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Il résulte d’une augmentation de pression dans une loge musculaire inextensible.', vraie: true, justification: 'L’œdème ou l’hématome intramusculaire ne peut se dissiper dans la gaine ostéofasciale inextensible, ce qui élève rapidement la pression au sein de la loge.' },
        ...
        { lettre: 'C', texte: 'Son traitement peut nécessiter une aponévrotomie de décharge.', vraie: true, justification: 'L’incision chirurgicale de l’aponévrose ouvre la loge et fait chuter la pression, seul moyen efficace de préserver la viabilité musculaire et nerveuse.' },
        { lettre: 'D', texte: 'Il constitue une urgence chirurgicale.', vraie: true, justification: 'Au-delà de quelques heures d’ischémie, les lésions musculaires et nerveuses deviennent irréversibles, ce qui impose une prise en charge sans délai.' },
