  ...
  qcm: [
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'La tête fémorale s’oriente en haut, en dedans et en avant.', vraie: true, justification: 'Cette triple orientation permet son emboîtement dans l’acétabulum, dont l’ouverture regarde elle-même en bas, en dehors et en avant.' },
        ...
        { lettre: 'C', texte: 'Le grand trochanter donne insertion à plusieurs muscles fessiers.', vraie: true, justification: 'Le moyen fessier et le petit fessier notamment s’y insèrent, ce qui en fait un repère palpable essentiel pour l’examen de la hanche.' },
        ...
        { lettre: 'E', texte: 'Le fémur est le plus volumineux os long du corps humain.', vraie: true, justification: 'Il doit transmettre l’intégralité du poids du corps entre le bassin et le genou, ce qui justifie sa robustesse et sa longueur.' },
      ],
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'C’est une énarthrose.', vraie: true, justification: 'La tête fémorale sphérique s’articule dans l’acétabulum concave, ce qui offre trois degrés de liberté comme à l’épaule, mais avec une bien meilleure congruence osseuse.' },
        ...
        { lettre: 'C', texte: 'Le ligament iliofémoral est le plus puissant des ligaments de la hanche.', vraie: true, justification: 'Situé en avant de l’articulation, il limite l’extension et l’hyperextension de la hanche et supporte l’essentiel du poids du corps en station debout.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Le quadriceps fémoral appartient à la loge antérieure.', vraie: true, justification: 'Ses quatre chefs occupent la loge antérieure de la cuisse et assurent l’extension du genou, sous innervation du nerf fémoral.' },
        ...
        { lettre: 'C', texte: 'Le sartorius participe à la flexion et à l’abduction de hanche.', vraie: true, justification: 'Ce muscle long et biarticulaire, le plus long du corps humain, combine flexion, abduction et rotation latérale de hanche avec la flexion du genou.' },
        { lettre: 'D', texte: 'Les muscles de la loge médiale sont principalement des adducteurs de hanche.', vraie: true, justification: 'Le long adducteur, le court adducteur, le grand adducteur, le gracile et le pectiné, tous innervés par le nerf obturateur, rapprochent la cuisse de l’axe du corps.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Sa limite supérieure est le ligament inguinal.', vraie: true, justification: 'Ce ligament forme la base du triangle, séparant la région fémorale du triangle fémoral proprement dit de la paroi abdominale sus-jacente.' },
        ...
        { lettre: 'C', texte: 'L’artère fémorale se situe entre le nerf fémoral et la veine fémorale.', vraie: true, justification: 'Cette position centrale correspond à l’ordre NAV (nerf, artère, veine) décrit de latéral en médial sous l’arcade inguinale.' },
        { lettre: 'D', texte: 'Le plancher est formé par les muscles iliopsoas et pectiné.', vraie: true, justification: 'Ces deux muscles fléchisseurs de hanche constituent le fond du triangle, sur lequel reposent les éléments vasculonerveux fémoraux.' },
    ...
    },
    {
      ...
      propositions: [
        ...
        { lettre: 'B', texte: 'C’est le nerf le plus volumineux du corps humain.', vraie: true, justification: 'Il regroupe les fibres destinées à la quasi-totalité de la jambe et du pied, ce qui en fait le plus gros tronc nerveux périphérique de l’organisme.' },
        { lettre: 'C', texte: 'Il se divise en nerf tibial et nerf fibulaire commun.', vraie: true, justification: 'Ces deux branches terminales poursuivent respectivement leur trajet dans les loges postérieure et latérale de la jambe.' },
        ...
        { lettre: 'E', texte: 'Il innerve les muscles ischiojambiers de la loge postérieure de la cuisse.', vraie: true, justification: 'Le biceps fémoral, le semi-tendineux et le semi-membraneux reçoivent leur innervation motrice du nerf sciatique avant même sa division terminale.' },
      ],
    ...
    },
    {
      ...
      propositions: [
        ...
        { lettre: 'B', texte: 'Il innerve le sartorius.', vraie: true, justification: 'Le sartorius appartient à la loge antérieure de la cuisse, dont tous les muscles dépendent de ce nerf issu du plexus lombaire.' },
        { lettre: 'C', texte: 'Sa branche sensitive terminale, le nerf saphène, innerve la face médiale de la jambe.', vraie: true, justification: 'Ce nerf accompagne la grande veine saphène et assure la sensibilité cutanée de la face médiale de la jambe jusqu’au pied.' },
