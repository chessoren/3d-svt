  ...
  qcm: [
    {
      ...
      propositions: [
        ...
        { lettre: 'C', texte: 'La lordose lombaire s’installe avec l’acquisition de la marche.', vraie: true, justification: 'Exact.' },
        { lettre: 'D', texte: 'Le sacrum présente une cyphose fixe, les vertèbres sacrées étant soudées.', vraie: true, justification: 'Exact.' },
    ...
    },
    {
      ...
      propositions: [
        ...
        { lettre: 'B', texte: 'Le foramen vertébral est délimité par le corps en avant et l’arc vertébral en arrière.', vraie: true, justification: 'Exact.' },
        ...
        { lettre: 'D', texte: 'Le foramen intervertébral livre passage au nerf spinal.', vraie: true, justification: 'Exact.' },
    ...
    },
    {
      ...
      propositions: [
        ...
        { lettre: 'B', texte: 'L’axis porte le processus odontoïde.', vraie: true, justification: 'Exact.' },
        { lettre: 'C', texte: 'Les vertèbres thoraciques présentent des fovéas costales pour l’articulation avec les côtes.', vraie: true, justification: 'Exact.' },
        { lettre: 'D', texte: 'Le sacrum est formé de cinq vertèbres soudées.', vraie: true, justification: 'Exact.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Le nucléus pulposus est la partie centrale et gélatineuse du disque.', vraie: true, justification: 'Exact.' },
        { lettre: 'B', texte: 'L’annulus fibrosus est formé de lamelles concentriques de fibres de collagène.', vraie: true, justification: 'Exact.' },
        ...
        { lettre: 'D', texte: 'Le disque intervertébral s’interpose entre deux corps vertébraux adjacents.', vraie: true, justification: 'Exact.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Le ligament longitudinal antérieur limite l’extension.', vraie: true, justification: 'Exact.' },
        { lettre: 'B', texte: 'Le ligament longitudinal postérieur se situe à l’intérieur du canal vertébral.', vraie: true, justification: 'Exact.' },
    ...
    },
    {
      ...
      propositions: [
        ...
        { lettre: 'D', texte: 'Le rachis lombaire autorise une grande amplitude de flexion-extension.', vraie: true, justification: 'Exact.' },
