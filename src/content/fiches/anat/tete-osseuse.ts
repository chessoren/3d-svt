  ...
  qcm: [
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'La suture coronale unit le frontal aux pariétaux.', vraie: true, justification: 'Exact.' },
        { lettre: 'B', texte: 'La suture lambdoïde unit les pariétaux à l’occipital.', vraie: true, justification: 'Exact.' },
        { lettre: 'C', texte: 'L’ethmoïde est un os pair.', vraie: false, justification: 'Faux : l’ethmoïde est un os impair et médian.' },
        { lettre: 'D', texte: 'Le temporal contient l’oreille moyenne et interne.', vraie: true, justification: 'Exact.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'La fosse crânienne antérieure loge les lobes frontaux.', vraie: true, justification: 'Exact.' },
        { lettre: 'B', texte: 'La lame criblée de l’ethmoïde appartient à la fosse crânienne antérieure.', vraie: true, justification: 'Exact.' },
        ...
        { lettre: 'D', texte: 'Le cervelet se situe dans la fosse crânienne postérieure.', vraie: true, justification: 'Exact.' },
        { lettre: 'E', texte: 'La fosse crânienne moyenne est formée notamment par le corps et les grandes ailes du sphénoïde.', vraie: true, justification: 'Exact.' },
      ],
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Le plancher de l’orbite est formé notamment par le maxillaire.', vraie: true, justification: 'Exact.' },
        ...
        { lettre: 'C', texte: 'La fissure orbitaire supérieure livre passage aux nerfs oculomoteurs.', vraie: true, justification: 'Exact.' },
        { lettre: 'D', texte: 'Une fracture du plancher orbitaire peut incarcérer le muscle droit inférieur.', vraie: true, justification: 'Exact.' },
        { lettre: 'E', texte: 'La paroi latérale de l’orbite est formée notamment par le zygomatique.', vraie: true, justification: 'Exact.' },
      ],
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Le sinus frontal se draine dans le méat nasal moyen.', vraie: true, justification: 'Exact.' },
        ...
        { lettre: 'C', texte: 'Les cellules ethmoïdales antérieures se drainent dans le méat nasal moyen.', vraie: true, justification: 'Exact.' },
        ...
        { lettre: 'E', texte: 'Le sinus maxillaire est creusé dans l’os maxillaire.', vraie: true, justification: 'Exact.' },
      ],
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'La mandibule est le seul os mobile du crâne.', vraie: true, justification: 'Exact.' },
        ...
        { lettre: 'C', texte: 'Le nerf alvéolaire inférieur chemine dans le canal mandibulaire.', vraie: true, justification: 'Exact.' },
        { lettre: 'D', texte: 'Les mouvements mandibulaires incluent la diduction.', vraie: true, justification: 'Exact, ce sont les mouvements latéraux.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Le foramen ovale livre passage au nerf mandibulaire (V3).', vraie: true, justification: 'Exact.' },
        ...
        { lettre: 'C', texte: 'L’artère carotide interne traverse le canal carotidien du temporal.', vraie: true, justification: 'Exact.' },
        { lettre: 'D', texte: 'Le foramen magnum livre passage à la moelle allongée.', vraie: true, justification: 'Exact.' },
