  ...
  qcm: [
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'L’ilium constitue la partie supérieure de l’os coxal.', vraie: true, justification: 'C’est la plus grande des trois pièces, reconnaissable à sa crête iliaque et à ses épines antéro- et postéro-supérieures, palpables en avant et en arrière.' },
        { lettre: 'B', texte: 'L’ischium porte la tubérosité ischiatique.', vraie: true, justification: 'Cette saillie postéro-inférieure supporte le poids du corps en position assise et donne insertion aux muscles ischiojambiers.' },
        ...
        { lettre: 'D', texte: 'L’acétabulum se forme à la jonction des trois pièces de l’os coxal.', vraie: true, justification: 'Chez l’enfant, un cartilage en Y réunit encore l’ilium, l’ischium et le pubis à ce niveau, avant de s’ossifier complètement à la puberté.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Le détroit supérieur passe par le promontoire sacré.', vraie: true, justification: 'Ce relief osseux postérieur constitue un repère obstétrical majeur, à partir duquel se mesurent les diamètres utiles du bassin.' },
        { lettre: 'B', texte: 'Le détroit inférieur est délimité en arrière par le coccyx.', vraie: true, justification: 'Le coccyx ferme le détroit inférieur en arrière, en continuité avec les branches ischiopubiennes et les tubérosités ischiatiques latéralement.' },
        ...
        { lettre: 'E', texte: 'Les tubérosités ischiatiques participent à la délimitation du détroit inférieur.', vraie: true, justification: 'Elles en forment les limites latérales et servent de repère pour mesurer le diamètre bi-ischiatique, important en obstétrique.' },
      ],
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Il est formé notamment par le muscle releveur de l’anus.', vraie: true, justification: 'Ce muscle, tendu en hamac entre les deux os coxaux, constitue l’essentiel du plancher pelvien et soutient les organes contre la pression abdominale.' },
        ...
        { lettre: 'C', texte: 'Le muscle ischiococcygien complète en arrière le diaphragme pelvien.', vraie: true, justification: 'Tendu de l’épine ischiatique au bord latéral du sacrum et du coccyx, il ferme la partie postérieure du plancher pelvien en arrière du releveur de l’anus.' },
        { lettre: 'D', texte: 'Son affaiblissement peut favoriser un prolapsus des organes pelviens.', vraie: true, justification: 'Les accouchements par voie basse, l’âge et l’hyperpression abdominale chronique peuvent affaiblir ce soutien et laisser descendre vessie, utérus ou rectum à travers le hiatus urogénital.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'La ligne bi-ischiatique sépare le périnée antérieur du périnée postérieur.', vraie: true, justification: 'Cette ligne transversale passant par les deux tubérosités ischiatiques divise le périnée en deux triangles, uro-génital en avant et anal en arrière.' },
        ...
        { lettre: 'C', texte: 'Le centre tendineux du périnée est un point de convergence musculaire.', vraie: true, justification: 'Le sphincter externe de l’anus, les muscles transverses superficiels et le muscle bulbospongieux s’y ancrent tous, en faisant un pivot clé de la statique périnéale.' },
        ...
        { lettre: 'E', texte: 'Le muscle bulbospongieux s’insère notamment sur le centre tendineux du périnée.', vraie: true, justification: 'Cette insertion médiane sur le corps périnéal explique pourquoi ce muscle est fréquemment concerné lors d’une déchirure obstétricale.' },
      ],
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Chez l’homme, la prostate occupe l’étage moyen du pelvis.', vraie: true, justification: 'Elle se situe, avec les vésicules séminales, entre la vessie en avant et le rectum en arrière, au-dessus du diaphragme pelvien.' },
        ...
        { lettre: 'C', texte: 'Le cul-de-sac recto-utérin est le point le plus déclive de la cavité péritonéale chez la femme.', vraie: true, justification: 'En position debout ou assise, tout épanchement intrapéritonéal tend à s’y accumuler, ce qui en fait un site clé de ponction diagnostique.' },
        { lettre: 'D', texte: 'Le cul-de-sac recto-vésical est l’équivalent masculin du cul-de-sac de Douglas.', vraie: true, justification: 'En l’absence d’utérus, ce cul-de-sac se forme entre la face postérieure de la vessie et le rectum, au même niveau topographique que le Douglas féminin.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Le bassin féminin a un diamètre bi-ischiatique plus grand que le bassin masculin.', vraie: true, justification: 'Cet écartement plus large entre les tubérosités ischiatiques augmente le diamètre utile du détroit inférieur pour faciliter le passage du mobile fœtal.' },
        ...
        { lettre: 'D', texte: 'Le détroit supérieur féminin est en moyenne plus ovalaire et plus large que le masculin.', vraie: true, justification: 'Cette forme plus ouverte, associée aux ailes iliaques plus évasées, augmente les diamètres utiles à l’engagement du mobile fœtal.' },
