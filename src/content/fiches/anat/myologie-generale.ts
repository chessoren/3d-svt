...
export const ficheMyologieGenerale: Fiche = {
  ...
  qcm: [
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'L’endomysium entoure chaque fibre musculaire.', vraie: true, justification: 'Exact.' },
        ...
        { lettre: 'C', texte: 'Le sarcomère est délimité par deux stries Z.', vraie: true, justification: 'Exact.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'La contraction concentrique s’accompagne d’un raccourcissement du muscle.', vraie: true, justification: 'Exact.' },
        ...
        { lettre: 'C', texte: 'La contraction excentrique correspond à un allongement du muscle sous tension.', vraie: true, justification: 'Exact.' },
        { lettre: 'D', texte: 'Freiner la descente d’une charge sollicite le muscle en contraction excentrique.', vraie: true, justification: 'Exact.' },
    ...
    },
    {
      ...
      propositions: [
        ...
        { lettre: 'B', texte: 'Le muscle antagoniste doit se relâcher pour permettre le mouvement de l’agoniste.', vraie: true, justification: 'Exact.' },
        { lettre: 'C', texte: 'Un muscle synergiste peut stabiliser une articulation voisine pour faciliter l’action de l’agoniste.', vraie: true, justification: 'Exact.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Un fascia sépare les différentes loges musculaires d’un membre.', vraie: true, justification: 'Exact.' },
        { lettre: 'B', texte: 'Une bourse séreuse est tapissée d’une membrane synoviale.', vraie: true, justification: 'Exact.' },
        { lettre: 'C', texte: 'Une gaine synoviale tendineuse entoure certains tendons longs, notamment au poignet et à la cheville.', vraie: true, justification: 'Exact.' },
        ...
        { lettre: 'E', texte: 'La ténosynovite correspond à l’inflammation d’une gaine synoviale tendineuse.', vraie: true, justification: 'Exact.' },
      ],
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Une unité motrice associe un motoneurone alpha et les fibres musculaires qu’il innerve.', vraie: true, justification: 'Exact.' },
        ...
        { lettre: 'C', texte: 'La plaque motrice libère de l’acétylcholine.', vraie: true, justification: 'Exact.' },
