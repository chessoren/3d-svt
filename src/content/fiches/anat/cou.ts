  ...
  qcm: [
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Le triangle cervical antérieur contient l’axe viscéral du cou.', vraie: true, justification: 'Ce triangle, limité par la ligne médiane et le bord antérieur du sternocléidomastoïdien, loge le larynx, la trachée, le pharynx, l’œsophage et la glande thyroïde.' },
        { lettre: 'B', texte: 'Le triangle cervical postérieur est limité par le bord postérieur du sternocléidomastoïdien.', vraie: true, justification: 'Il est délimité en avant par ce bord musculaire, en arrière par le trapèze et en bas par la clavicule.' },
        ...
        { lettre: 'D', texte: 'Le nerf accessoire (XI) traverse le triangle cervical postérieur.', vraie: true, justification: 'Il y chemine superficiellement pour innerver le muscle trapèze, ce qui l’expose à une lésion lors de gestes chirurgicaux ou de biopsies dans ce triangle.' },
    ...
    },
    {
      ...
      propositions: [
        ...
        { lettre: 'B', texte: 'Il se termine sur le processus mastoïde.', vraie: true, justification: 'Il se termine sur le processus mastoïde et la ligne nucale supérieure de l’occipital, expliquant son action sur les mouvements de la tête.' },
        ...
        { lettre: 'E', texte: 'Sa contraction bilatérale participe à la flexion de la tête.', vraie: true, justification: 'Lorsque les deux muscles se contractent simultanément, leurs actions de rotation opposées s’annulent et il ne reste que la flexion de la tête.' },
      ],
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'La lame prétrachéale entoure l’axe viscéral du cou.', vraie: true, justification: 'Ce feuillet fascial antérieur enveloppe le larynx, la trachée, la glande thyroïde et l’œsophage cervical.' },
        { lettre: 'B', texte: 'La lame prévertébrale recouvre les muscles prévertébraux et la chaîne sympathique cervicale.', vraie: true, justification: 'Ce feuillet postérieur, plaqué contre le rachis cervical, enveloppe les muscles prévertébraux et la chaîne sympathique qui chemine à leur surface.' },
        ...
        { lettre: 'D', texte: 'La lame superficielle entoure le muscle trapèze.', vraie: true, justification: 'Ce feuillet d’enveloppe, le plus externe, entoure la totalité du cou et englobe donc à la fois le sternocléidomastoïdien et le trapèze.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'L’artère carotide commune est la structure la plus médiale de la gaine carotidienne.', vraie: true, justification: 'Dans la disposition classique du paquet vasculonerveux, l’artère est médiale, la veine jugulaire interne est latérale et le nerf vague se situe en arrière, entre les deux.' },
        ...
        { lettre: 'C', texte: 'Le nerf vague se situe en arrière, entre l’artère et la veine.', vraie: true, justification: 'Cette position postérieure, entre l’artère carotide commune en dedans et la veine jugulaire interne en dehors, est un repère classique en coupe transversale du cou.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Elle comprend deux lobes réunis par un isthme.', vraie: true, justification: 'Cette organisation en deux lobes latéraux reliés par un isthme médian donne à la thyroïde sa forme classique en papillon.' },
        { lettre: 'B', texte: 'Les artères thyroïdiennes supérieures naissent de l’artère carotide externe.', vraie: true, justification: 'Elles constituent la première branche antérieure de la carotide externe, destinée au pôle supérieur de chaque lobe thyroïdien.' },
        ...
        { lettre: 'E', texte: 'L’isthme thyroïdien croise la face antérieure des deuxième et troisième anneaux trachéaux.', vraie: true, justification: 'Ce repère trachéal précis guide notamment la voie d’abord chirurgicale et la trachéotomie, réalisée au-dessus ou au-dessous de l’isthme selon les cas.' },
      ],
      correction: 'Réponses exactes : A, B et E.',
      difficulte: 2,
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Il est formé des rameaux ventraux de C1 à C4.', vraie: true, justification: 'C’est l’union de ces quatre rameaux ventraux qui constitue le plexus cervical, distinct du plexus brachial formé plus bas.' },
        ...
        { lettre: 'D', texte: 'Le plexus cervical se situe en arrière du muscle sternocléidomastoïdien.', vraie: true, justification: 'Il est profondément situé en regard des processus transverses cervicaux, sous le sternocléidomastoïdien qui le recouvre.' },
        { lettre: 'E', texte: 'Les nerfs cutanés cervicaux superficiels assurent la sensibilité cutanée du cou.', vraie: true, justification: 'Le petit occipital, le grand auriculaire, le transverse du cou et les nerfs supraclaviculaires innervent la peau du cou, de la région rétro-auriculaire et du haut du thorax.' },
      ],
