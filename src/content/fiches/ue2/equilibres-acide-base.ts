...
export const ficheEquilibresAcideBase: Fiche = {
  ...
  qcm: [
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Elle s’écrit pH = pKa + log([A−]/[AH]).', vraie: true, justification: 'Exact.' },
        ...
        { lettre: 'C', texte: 'Si pH > pKa, la forme basique A− est majoritaire.', vraie: true, justification: 'Exact.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Une solution tampon est un mélange d’un acide faible et de sa base conjuguée.', vraie: true, justification: 'Exact.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Le système bicarbonate est le principal tampon extracellulaire.', vraie: true, justification: 'Exact.' },
        { lettre: 'B', texte: 'Le pKa apparent du couple H2CO3/HCO3− est proche de 6,1.', vraie: true, justification: 'Exact.' },
    ...
    },
    {
      ...
      propositions: [
        ...
        { lettre: 'D', texte: 'La bicarbonatémie physiologique est proche de 24 mmol/L.', vraie: true, justification: 'Exact.' },
        { lettre: 'E', texte: 'La PaCO2 physiologique est proche de 40 mmHg.', vraie: true, justification: 'Exact.' },
      ],
