  ...
  qcm: [
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Un alcool primaire porte le groupement -OH sur un carbone lié à un seul autre carbone.', vraie: true, justification: 'Exact.' },
    ...
    },
    {
      ...
      propositions: [
        ...
        { lettre: 'E', texte: 'Le groupement carbonyle est noté C=O.', vraie: true, justification: 'Exact.' },
      ],
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Le groupement carboxyle se note -COOH.', vraie: true, justification: 'Exact.' },
        ...
        { lettre: 'D', texte: 'Les triglycérides sont des esters d’acides gras et de glycérol.', vraie: true, justification: 'Exact.' },
    ...
    },
    {
      ...
      propositions: [
        { lettre: 'A', texte: 'Une amine tertiaire porte trois groupements carbonés liés à l’azote.', vraie: true, justification: 'Exact.' },
        { lettre: 'B', texte: 'Un amide résulte de la condensation d’un acide carboxylique et d’une amine.', vraie: true, justification: 'Exact.' },
        ...
        { lettre: 'D', texte: 'La liaison peptidique est une fonction amide.', vraie: true, justification: 'Exact.' },
    ...
    },
    {
      ...
      propositions: [
        ...
        { lettre: 'C', texte: 'Le suffixe -one désigne une fonction cétone.', vraie: true, justification: 'Exact.' },
        ...
        { lettre: 'E', texte: 'Le suffixe -amide désigne la fonction amide.', vraie: true, justification: 'Exact.' },
      ],
    ...
    },
    {
      ...
      propositions: [
        ...
        { lettre: 'C', texte: 'Les acides gras sont des exemples biologiques d’acides carboxyliques.', vraie: true, justification: 'Exact.' },
